...
from .views import main_page_view, scraper, detail_book_view, edit_book_view, create_book_view, BookRemoveView

urlpatterns = [
    path('', main_page_view, name='books_view'),
    path('scraping/', scraper, name='scraper'),
    path('create/', create_book_view, name='create_book_view'),
    path('delete/<str:pk>/', BookRemoveView.as_view(), name='book_delete'),
    ...
    path('import/<str:query>/', scraper, name='book_import')
]
